...
from app.models import inventario, ingreso_inventario, producto, sucursal
from app.schemas import InventarioIn, Inventario, IngresoInventarioIn, IngresoInventario
...
async def ingresar_inventario(data: IngresoInventarioIn):
    ...
    async with database.transaction():
        ...
        # 4. REGISTRAR EL INGRESO (guardamos "5 bultos" tal cual)
        ...
        await registrar_movimiento(
            ...
            motivo=f"Ingreso de {data.cantidad} ({prod_obj['unidad_medida']})",
        )
