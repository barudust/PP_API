...
async def lifespan(app: FastAPI):
    ...
    # Asegura que el catálogo de permisos exista y siembra defaults por rol.
    await sincronizar_catalogo()
    yield
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=settings.CORS_ORIGINS,  # Configurable por .env (web dev/prod)
